...
def mk_correctness_0_2():
    return GEval(
        ...
        rubric=[
            Rubric(
                score_range=(0, 0),
                expected_outcome="Completely incorrect; contradicts the expected output or invents key facts/rules/points.",
            ),
            Rubric(
                score_range=(1, 1),
                expected_outcome="Partially correct; some correct info but missing or wrong important parts; no major fabricated facts.",
            ),
            Rubric(
                score_range=(2, 2),
                expected_outcome="Fully correct and consistent with the expected output; no fabricated facts/rules/points.",
            ),
        ],
        threshold=0.0,
        # strict_mode=True
